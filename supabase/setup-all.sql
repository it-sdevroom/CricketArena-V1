...
-- <<< END 20260101000000_init.sql

-- >>> BEGIN 20260101000001_rls.sql
...
-- <<< END 20260101000001_rls.sql

-- >>> BEGIN 20260101000002_views.sql
...
-- <<< END 20260101000002_views.sql

-- >>> BEGIN 20260101000003_registrations.sql
...
-- <<< END 20260101000003_registrations.sql

-- >>> BEGIN 20260101000004_account_deletion.sql
...
-- <<< END 20260101000004_account_deletion.sql

-- >>> BEGIN 20260101000005_media_and_super_over.sql
...
-- <<< END 20260101000005_media_and_super_over.sql

-- >>> BEGIN 20260101000006_dls_and_push.sql
...
-- <<< END 20260101000006_dls_and_push.sql

-- >>> BEGIN 20260101000007_channels_and_squads.sql
...
-- <<< END 20260101000007_channels_and_squads.sql

-- >>> BEGIN 20260101000007_summary_scores.sql
...
-- <<< END 20260101000007_summary_scores.sql

-- >>> BEGIN 20260101000008_commentary.sql
...
-- <<< END 20260101000008_commentary.sql

-- >>> BEGIN 20260101000008_summary_performances.sql
...
-- <<< END 20260101000008_summary_performances.sql

-- >>> BEGIN 20260101000009_match_views.sql
...
-- <<< END 20260101000009_match_views.sql

-- >>> BEGIN 20260101000010_group_position.sql
...
-- <<< END 20260101000010_group_position.sql
